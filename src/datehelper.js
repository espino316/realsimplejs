RS.DateHelper = function() {} // end function DateHelper
RS.DateHelper.timestamp = function() {
  return Math.floor(Date.now() / 1000); // end Math floor
}; // end function timestamp

RS.DateHelper.getDateParts = function(date) {
...
RS.DateHelper.diff = function(date1, date2){
